...
public class DeleteUserServlet extends HttpServlet {
    ...
    private final String DELETEERROR = "adminPage.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (session != null) {
                ...
                boolean result = dao.deleteUser(status, userid);
                if (result) {
                    url = "ProcessServlet?txtSearchUser=&btAction=Search";
                }
            } else {
                url = LOGINPAGE;
            }
        } catch (Exception e) {
            log("ERROR at DeleteUserServlet: " + e.getMessage());
        } finally {
