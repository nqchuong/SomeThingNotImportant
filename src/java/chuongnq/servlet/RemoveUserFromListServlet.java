 ...
 * @author CHUONG
 */
public class RemoveUserFromListServlet extends HttpServlet {

    private final String SUCCESS = "listOfPromotions.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("ERROR at RemoveUserFromListServlet: " + e.getMessage());
        } finally {
